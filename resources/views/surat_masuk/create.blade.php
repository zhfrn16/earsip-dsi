...
<script>
    ...
    $(document).ready(function() {
        console.log('Document ready - surat masuk create');
        console.log('jQuery version:', $.fn.jquery);
        console.log('Custom file inputs found:', $('.custom-file-input').length);

        // File input custom label - Enhanced version
        $(document).on('change', '.custom-file-input', function() {
            console.log('jQuery File input changed - Enhanced');
            console.log('Input element:', this);
            console.log('Files property:', this.files);

            // Get filename
            let fileName = 'Pilih file';
            if (this.files && this.files.length > 0) {
                fileName = this.files[0].name;
                console.log('File selected via files property:', fileName);
            } else {
                let fullPath = $(this).val();
                console.log('Full path from val():', fullPath);
                if (fullPath) {
            ...
            console.log('Final filename to display:', fileName);
            ...
            console.log('jQuery Label updated successfully');
        });

        // Test direct event binding too
        $('.custom-file-input').on('change', function() {
            console.log('Direct binding also triggered');
        });
