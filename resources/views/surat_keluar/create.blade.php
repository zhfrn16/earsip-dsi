...
@section('title', 'Tambah Surat Keluar | e-Arsip DSI')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Form Tambah Surat Keluar</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="id_surat_keluar">ID Surat Keluar <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('id_surat_keluar') is-invalid @enderror"
                                           id="id_surat_keluar" name="id_surat_keluar" value="{{ old('id_surat_keluar') }}" required>
                                    @error('id_surat_keluar')
