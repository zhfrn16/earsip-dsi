...
<head>
  ...
  <title>@yield('title')</title>
    ...
    <link rel="preload" href="https://code.jquery.com/jquery-3.3.1.min.js" as="script" integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=" crossorigin>
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/select2@4.0.6/dist/js/select2.min.js" as="script">
    <link rel="preload" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css" as="style">
    <link rel="preload" href="https://code.jquery.com/ui/1.12.0/jquery-ui.min.js" as="script"integrity="sha256-eGE6blurk5sHj+rmkfsGYeKyZx3M4bG+ZlFyA7Kns7E=" crossorigin>
    <link rel="preload" href="https://code.jquery.com/jquery-migrate-3.0.0.min.js" as="script" >
    <link rel="preload" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.22/b-1.6.5/b-flash-1.6.5/b-html5-1.6.5/b-print-1.6.5/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.0/sp-1.2.1/sl-1.3.1/datatables.min.js" as="script" >
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/pdfmake@0.1.36/build/pdfmake.min.js" as="script" >
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/pdfmake@0.1.36/build/vfs_fonts.js" as="script" >
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/popper.js@1.14.7/dist/umd/popper.min.js" as="script" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin>
    <link rel="preload" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" as="script" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin>
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/jquery.nicescroll@3.7.6/jquery.nicescroll.min.js" as="script" >
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/moment@2.24.0/min/moment.min.js" as="script" >
    <link rel="preload" href="https://unpkg.com/sweetalert/dist/sweetalert.min.js" as="script" >
    <link rel="preload" href="//cdn.jsdelivr.net/npm/sweetalert2@11" as="script" >
    <link rel="preload" href="{{ url('stisla/assets/js/stisla.js') }}" as="script">
    <link rel="preload" href="{{ url('stisla/assets/js/scripts.js') }}" as="script">
    <link rel="preload" href="{{ url('js/app2.js') }}" as="script">
    <link rel="preload" href="{{ url('stisla/assets/js/page/index.js') }}" as="script">
  <!-- General CSS Files -->
  ...
  <link rel="stylesheet" href="{{ url('css/fontawesome/all.css') }}" crossorigin="anonymous">
  <link href="https://cdn.jsdelivr.net/npm/select2@4.0.6/dist/css/select2.min.css" rel="stylesheet" />
  {{-- <!-- CSS Libraries -->
  ...
  <script src="https://cdn.jsdelivr.net/npm/select2@4.0.6/dist/js/select2.min.js"></script>
...
<body>
  ...
  <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/pdfmake@0.1.36/build/pdfmake.min.js"></script>
  <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/pdfmake@0.1.36/build/vfs_fonts.js"></script>
